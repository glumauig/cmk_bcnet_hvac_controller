...
def discover_hvac_controller_prev_volume(section):
    yield Service()

def check_hvac_controller_prev_volume(section):
...
register.check_plugin(
    name = "hvac_controller_prev_volume",
    service_name='HVAC Controller Previous Year Volume Total',
    discovery_function= discover_hvac_controller_prev_volume,
    check_function= check_hvac_controller_prev_volume,
    )
