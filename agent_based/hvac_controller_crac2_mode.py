...
def discover_hvac_controller_crac2_mode(section):
    yield Service()

def check_hvac_controller_crac2_mode(section):
    ...
    if hvac_snmp_value == 0:
        ...
        summary_hvac = "CRAC-2-Mode: " + str(hvac_snmp_value_converted)
...
register.check_plugin(
    name = "hvac_controller_crac2_mode",
    service_name='HVAC Controller CRAC-2-Mode',
    discovery_function= discover_hvac_controller_crac2_mode,
    check_function= check_hvac_controller_crac2_mode,
    )
