...
def discover_hvac_controller_energy_hour(section):
    yield Service()

def check_hvac_controller_energy_hour(section):
...
register.check_plugin(
    name = "hvac_controller_energy_hour",
    service_name='HVAC Controller Energy Hour',
    discovery_function= discover_hvac_controller_energy_hour,
    check_function= check_hvac_controller_energy_hour,
    )
