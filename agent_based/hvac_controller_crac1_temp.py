...
def discover_hvac_controller_crac1_temp(section):
    yield Service()

def check_hvac_controller_crac1_temp(section):
    ...
    summary_hvac = "CRAC1 RA Temperature " + ": "+str(hvac_snmp_value)+" C" +", "+str(hvac_snmp_value_converted)+" F"
...
register.check_plugin(
    name = "hvac_controller_crac1_temp",
    service_name='HVAC Controller CRAC1 RA Temperature',
    discovery_function= discover_hvac_controller_crac1_temp,
    check_function= check_hvac_controller_crac1_temp,
    )
