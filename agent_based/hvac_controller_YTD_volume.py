...
def discover_hvac_controller_YTD_volume(section):
    yield Service()

def check_hvac_controller_YTD_volume(section):
...
register.check_plugin(
    name = "hvac_controller_YTD_volume",
    service_name='HVAC Controller Year to Date Volume Total',
    discovery_function= discover_hvac_controller_YTD_volume,
    check_function= check_hvac_controller_YTD_volume,
    )
